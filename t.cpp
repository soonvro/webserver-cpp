...
/*   Updated: 2023/10/23 12:24:39 by insub            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const char *basic_env[] = {"AUTH_TYPE",
                                  "CONTENT_LENGTH",
                                  "CONTENT_TYPE",
                                  "GATEWAY_INTERFACE",
                                  "PATH_INFO",
...
int main(int argc, char *argv[]) {
  if (argc == 5) {
    ...
    if (!strcmp(command[0], "php-cgi")) {
      ...
      env_set["SCRIPT_NAME"] = "/Users/insub/Downloads/tester";
    }
    ...
    */
    ...
    std::cout << "Usage: ./a.out [cgi_tester or php-cgi] [HTTP method] "
